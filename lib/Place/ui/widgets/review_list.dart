...
import 'package:platzi_app/Place/ui/widgets/review.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      ...
      children: <Widget>[
        ...
        Review("assets/img/michael.jpg", "Michael Quimbayo", "2 review · 5 photos", "There is an amazing place in Sri Lanka"),
